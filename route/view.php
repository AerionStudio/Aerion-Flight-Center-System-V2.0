...
$url_route = "http://api.xflysim.com/v1/route/?dep=" . urlencode($route_get_body['dep']) . "&arr=" . urlencode($route_get_body['arr']) . "&token=" . urlencode($route_get_body['token']) . "&dbid=" . urlencode($route_get_body['dbid']);
...
$url_route_parse = "http://api.xflysim.com/v1/parseRoute/?route=" . urlencode($route_parse_get_body['route']) . "&token=" . urlencode($route_parse_get_body['token']) . "&type=" . urlencode($route_parse_get_body['type']);
...
$url_airport_dep = "http://api.xflysim.com/v1/airport/?icao=" . urlencode($airport_dep_get_body['icao']) . "&token=" . urlencode($airport_dep_get_body['token']);
...
$url_airport_arr = "http://api.xflysim.com/v1/airport/?icao=" . urlencode($airport_arr_get_body['icao']) . "&token=" . urlencode($airport_arr_get_body['token']);
        ...
        <div class="container text-center">
            <div class="row">
                ...
                <div class="col">
                    ...
                    $url_weather_dep = "http://api.xflysim.com/v1/weather/?icao=" . urlencode($weather_dep_get_body['icao']) . "&token=" . urlencode($weather_dep_get_body['token']);
                    ...
                    $url_weather_arr = "http://api.xflysim.com/v1/weather/?icao=" . urlencode($weather_arr_get_body['icao']) . "&token=" . urlencode($weather_arr_get_body['token']);
